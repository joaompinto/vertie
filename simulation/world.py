...
class World:
    ...
    def circle_collide_circle(self, preserve_impulse):
        ...
        for i in range(len(self.circle_shapes)):
            ...
            for j in range(i+1, len(self.circle_shapes)):
                ...
                if length < target: # Collision detected
    ...
    def circle_collide_line(self, preserve_impulse):
    ...
    def step(self):
        ...
        for i in range(steps):
            ...
            self.circle_collide_line(True)
            self.circle_collide_circle(False)
            self.border_collide()           
            self.inertia()  
            self.circle_collide_line(False)
            self.circle_collide_circle(True)
